    ...
    def __init__(self, scope: Construct, construct_id: str, vpc, secrets, knowledge_base_id, data_bucket, **kwargs) -> None:
        ...
        container = task_definition.add_container(
            ...
            command=[
                ...
                "\n"
                "st.markdown('---')\n"
                "st.markdown('<div style=\"text-align: center; color: #666; padding: 1rem;\"><p>🗂️ S3 기반 문서 검색 + Claude 3.5 Sonnet RAG</p><p>📚 키워드 매칭을 통한 관련 문서 검색</p><p>🔄 1시간마다 Notion 데이터 자동 동기화</p></div>', unsafe_allow_html=True)\n"
                "EOF\n"
